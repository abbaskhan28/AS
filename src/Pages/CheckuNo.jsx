...
//       className="fixed left-1/2 top-1/2 z-50 w-[340px] cursor-grab select-none rounded-2xl bg-[#ffe9df] px-6 py-8 text-center active:cursor-grabbing"
//       style={{
...
//           className="rounded-md bg-white px-5 py-2 text-sm text-gray-700 shadow-sm transition-all duration-200 hover:scale-105 hover:shadow-md"
//         >
//           Yes
//         </button>
